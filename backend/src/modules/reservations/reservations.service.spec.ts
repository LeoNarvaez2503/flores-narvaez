...
describe('ReservationsService.computeAmounts', () => {
  const svc = new ReservationsService({} as any, {} as any, {} as any, { publishAuditEvent: jest.fn() } as any);
...
describe('ReservationsService.payReservation', () => {
  ...
  const audit = { publishAuditEvent: jest.fn() } as any;
  const svc = new ReservationsService(prisma, payments, email, audit);
...
describe('ReservationsService.createReservation — stock', () => {
  ...
  const svc = new ReservationsService(prisma, {} as any, {} as any, { publishAuditEvent: jest.fn() } as any);

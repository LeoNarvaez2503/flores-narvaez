# Script de Despliegue Automatico para Windows PowerShell
$ErrorActionPreference = "Stop"

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "      CavaLocal - Despliegue Automatico en Kubernetes      " -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan

Write-Host "[1/5] Iniciando Minikube cluster..." -ForegroundColor Yellow
minikube start --driver=docker

Write-Host "[2/5] Habilitando Addon Ingress NGINX..." -ForegroundColor Yellow
minikube addons enable ingress

Write-Host "[3/5] Construyendo imagenes Docker locales..." -ForegroundColor Yellow
...
Write-Host "[4/5] Cargando imagenes Docker en Minikube..." -ForegroundColor Yellow
...
Write-Host "Esperando que los Pods esten listos (Ready)..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "  Agregue la siguiente linea a C:\Windows\System32\drivers\etc\hosts:" -ForegroundColor Yellow
...
Write-Host "  Acceso a Auditoria:   http://conjunta3p.espe.edu.ec/api/audit" -ForegroundColor White
